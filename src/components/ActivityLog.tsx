              ...
              <div className="flex-1 w-full">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mt-8 text-sm font-bold text-gray-600 w-full">
                      <div className="flex items-center gap-3 border-b border-gray-100 pb-1 min-w-0">
                          ...
                          <input type="text" value={headerInfo.region} onChange={e => setHeaderInfo(p => ({...p, region: e.target.value}))} className="bg-transparent focus:border-indigo-500 p-0 text-gray-900 outline-none flex-1 min-w-0" />
                      </div>
                      <div className="flex items-center gap-3 border-b border-gray-100 pb-1 min-w-0">
                          <span className="text-gray-400 uppercase text-[10px] tracking-widest whitespace-nowrap w-16">Manager:</span>
                          <input type="text" placeholder="Enter name..." value={headerInfo.manager} onChange={e => setHeaderInfo(p => ({...p, manager: e.target.value}))} className="bg-transparent focus:border-indigo-500 p-0 text-gray-900 outline-none flex-1 min-w-0" />
                      </div>
                      <div className="flex items-center gap-3 border-b border-gray-100 pb-1 min-w-0">
                          <span className="text-gray-400 uppercase text-[10px] tracking-widest whitespace-nowrap w-16">Date:</span>
                          <input type="date" value={headerInfo.date} onChange={e => setHeaderInfo(p => ({...p, date: e.target.value}))} className="bg-transparent focus:border-indigo-500 p-0 text-gray-900 outline-none flex-1 min-w-0" />
                      </div>
                      <div className="flex items-center gap-3 border-b border-gray-100 pb-1 min-w-0">
                          <span className="text-gray-400 uppercase text-[10px] tracking-widest whitespace-nowrap w-16">Dept:</span>
                          <input type="text" placeholder="Enter department..." value={headerInfo.dept} onChange={e => setHeaderInfo(p => ({...p, dept: e.target.value}))} className="bg-transparent focus:border-indigo-500 p-0 text-gray-900 outline-none flex-1 min-w-0" />
                      </div>
                  </div>
              </div>
