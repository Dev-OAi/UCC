...
export const Header: React.FC<HeaderProps> = ({
  searchTerm, onSearchChange, isSearchOpen, setIsSearchOpen,
  searchResults, onResultClick, onQuickLinkClick, isProductsUnlocked = false,
  onToggleLeftSidebar, onToggleRightSidebar, isRightSidebarOpen,
  isDarkMode, onToggleDarkMode, searchRef
}) => {
  return (
