...
import { Home, ChevronDown, ChevronRight, MapPin, Hash, Layers, BarChart3, Package, ClipboardList, Lock, Unlock, FileText, Target, Zap, Bot } from 'lucide-react';
    ...
    <>
      ...
      <nav className="p-4 space-y-6">
        <div className="space-y-1">
          ...
          <button
            onClick={() => handleTabClick('UCC Results')}
            role="tab"
            aria-selected={activeTab === 'UCC Results'}
            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
          ...
          >
            ...
            <span className="text-sm font-medium font-bold">UCC Automation</span>
          </button>
